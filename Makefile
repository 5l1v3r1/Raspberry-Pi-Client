...
CONFIG_CLEAN_FILES = Doxyfile libnfc.pc
...
am__DIST_COMMON = $(srcdir)/Doxyfile.in $(srcdir)/Makefile.in \
	$(srcdir)/config.h.in $(srcdir)/libnfc.pc.in AUTHORS COPYING \
...
DLLTOOL = false
DOXYGEN = 
DRIVERS_CFLAGS =  -DDRIVER_PN532_UART_ENABLED
DSYMUTIL = 
DUMPBIN = 
ECHO_C = 
ECHO_N = -n
...
STRIP = strip
VERSION = 1.7.1
abs_builddir = /home/pi/libnfc/libnfc-1.7.1
abs_srcdir = /home/pi/libnfc/libnfc-1.7.1
abs_top_builddir = /home/pi/libnfc/libnfc-1.7.1
abs_top_srcdir = /home/pi/libnfc/libnfc-1.7.1
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
...
install_sh = ${SHELL} /home/pi/libnfc/libnfc-1.7.1/install-sh
...
libnfc.pc: $(top_builddir)/config.status $(srcdir)/libnfc.pc.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
